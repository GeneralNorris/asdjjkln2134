$(function() {
	...
	$("#dataTable").tablesorter({headers: { 1:{sorter:'text'}, 3:{sorter:'innerFirst_A_text'}}});
	//END tablesorter.com ---
...
//--- removeDialog ---
	var $removeDialog = $('<div></div>')
			.dialog({
				...
				open: function(event, ui) {
					$(this).html('Diesen Eintrag l&ouml;schen?');
	...
	$tableTRs.find("a.deleteUser").click(function (e) {
		e.preventDefault();
